...
// salut je suis un basket en filterscript
// nous sommes autistitique


// rev basketball willowfield 1.0

// positions doit etre changer ou rajouter un new terrain pour les projects a Idlewood.

// LES BONNES POSITIONS SONT
...
1955.0315, -1586.8690, 13.6660 // BALLE MILIEU DU TERRAIN
1955.0210, -1576.2802, 13.6582  // PANIER LA VU VERS LHOPITAL
1955.4005, -1599.6041, 13.6582 // PANIER VU VERS IDLEWOOD GAS
...
{
    if (strcmp("/bballe", cmdtext, true, 6) == 0)
    {
        new Float:x, Float:y, Float:z;
        GetPlayerPos(playerid, x, y, z);
        DestroyObject(Ball);
        Ball = CreateObject(2114, x+random(3), y+random(3), z-0.8, 0, 0, 96); // 2795.5237,-2019.6152,13.5547
        return 1;
    }
...
public BallDown2(playerid)
{
    ...
    Baller = 999;
    ShootingBall = 0;
    GameTextForPlayer(playerid, "~g~But!", 3000, 3);
    BallBounce = 1;
    return 1;
}
...
public BallDown4(playerid)
{
    ...
    Baller = 999;
    ShootingBall = 0;
    GameTextForPlayer(playerid, "~r~Manquer!", 3000, 3);
    BallBounce = 1;
    return 1;
}
